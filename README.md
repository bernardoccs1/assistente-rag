# Assistente RAG - Pipeline de Busca Semântica e LLM
...
Linguagem e Framework API: Python 3.11 / FastAPI / Uvicorn

Orquestração de IA e LLM: LangChain / Google Gemini API

Vector Database: ChromaDB (Persistência e Busca Vetorial)

Conteinerização e Ambiente: Docker / Docker Compose

Qualidade e CI/CD: Pytest / Ruff / GitHub Actions
...
Bash
pytest
Próximos Passos (Roadmap de MLOps e Infra)
